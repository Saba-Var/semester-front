...
export const profileFormSchema = Yup.object({
  ...
  oldPassword: Yup.string().when('passwordEditMode', {
    is: true,
    then: Yup.string().required('old_password_required'),
  }),

  newPassword: Yup.string().when('passwordEditMode', {
    is: true,
    then: Yup.string()
  ...
  confirmPassword: Yup.string().when('passwordEditMode', {
    is: true,
    then: Yup.string()
